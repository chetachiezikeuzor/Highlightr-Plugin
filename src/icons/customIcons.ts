...
export function createHighlighterIcons(
  ...
  for (const key of plugin.settings.highlighterOrder) {
    let highlighterpen = `highlightpen-${key}`.toLowerCase();
    highlighterIcons[
      highlighterpen
